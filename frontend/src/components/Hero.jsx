        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Experienced and trained professionals providing compassionate care, medical tourism support, and reliable home healthcare for your loved ones. 
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-jelcos-dark">5000+</div>
